...
def home(request):
    if request.method == "GET":
        return render(request, 'labviva/home.html')

    elif request.method == "POST":
        code = request.POST['u-code']
        ##########################
        operators = {'=': 'Assignment op', '+': 'Addition op', '-': 'Subtraction op', '/': 'Division op',
                     '*': 'Multiplication op', '<': 'Lessthan op', '>': 'Greaterthan op', '(': 'Other 1',
        ...
        identifier = {'a': 'id_1', 'b': 'id_2', 'c': 'id_3', 'd': 'id_4'}
        ...
        return render(request, 'labviva/table.html', context)
